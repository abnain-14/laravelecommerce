				...
				<div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1" data-nav="true" data-dots="false">
					...
					<div class="item-slide">
						...
						<div class="slide-info slide-1">
							...
							<p class="sale-info">Maximum price: <span class="price">{{$slide->price}}</span></p>
				...
				@foreach ($sproducts as $sproduct)
					<div class="product product-style-2 equal-elem ">
						...
						<div class="product-info">
							...
							<div class="wrap-price"><ins><p class="product-price">Tsh{{$sproduct->sale_price}}</p></ins> <del><p class="product-price">Tsh{{$sproduct->regular_price}}</p></del></div>
						</div>
					</div>
				@endforeach			
				</div>
								...
								<div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}' >
									...
									<div class="product product-style-2 equal-elem ">
										...
										<div class="product-info">
											...
											<div class="wrap-price"><span class="product-price">Tsh{{$lproduct->regular_price}}</span></div>
										</div>
									</div>
									@endforeach
								</div>
								...
								@foreach ($c_products as $c_product)
									<div class="product product-style-2 equal-elem ">
										...
										<div class="product-info">
											...
											<div class="wrap-price"><span class="product-price">Tsh{{$c_product->regular_price}}</span></div>
										</div>
									</div>
									@endforeach	
