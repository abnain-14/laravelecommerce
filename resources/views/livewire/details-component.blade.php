            ...
            <div class="wrap-product-detail">
                ...
                <div class="detail-info">
                    ...
                    <div class="wrap-price">
                        <span class="product-price">Tsh{{$product->sale_price}}</span>
                        <del><span class="product-price regprice">Tsh{{$product->regular_price}}</span></del>
                    </div>
                    @else
                    <div class="wrap-price"><span class="product-price">Tsh{{$product->regular_price}}</span></div>
                    @endif
                        ...
                        <li class="product-item">
                            <div class="product product-widget-style">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="wrap-price"><span class="product-price">Tsh{{$p_product->regular_price}}</span></div>
                                </div>
                            </div>
                        </li>
                        @endforeach
                    ...
                    <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}' >
                        ...
                        <div class="product product-style-2 equal-elem ">
                            ...
                            <div class="product-info">
                                ...
                                <div class="wrap-price"><span class="product-price">Tsh{{$r_product->regular_price}}</span></div>
                            </div>
                        </div>
                        @endforeach
                    </div>
