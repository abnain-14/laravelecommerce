				...
				<div class="topbar-menu-area">
					<div class="container">
						<div class="topbar-menu left-menu">
							<ul>
								<li class="menu-item" >
									<a title="Hotline: (+123) 456 789" href="#" ><span class="icon label-before fa fa-mobile"></span>Tel: +25522145877</a>
								</li>
							</ul>
						</div>
...
<!--
	...
	<script src="https://cdn.tiny.cloud/1/oho874njnxqho1w21rkuqiwz1k6y3hao5sdqfeg87pv8macf/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
